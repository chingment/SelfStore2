...
public class EMPhoneStateManager {
    ...
    private static EMPhoneStateManager INSTANCE = null;

    private TelephonyManager telephonyManager;
    private List<PhoneStateCallback> stateCallbacks = null;

    public static EMPhoneStateManager get(Context context) {
        if (INSTANCE == null) {
            synchronized (EMPhoneStateManager.class) {
                if (INSTANCE == null) {
                    INSTANCE = new EMPhoneStateManager(context);
                }
            }
        }
        return INSTANCE;
    ...
    private EMPhoneStateManager(Context context) {
