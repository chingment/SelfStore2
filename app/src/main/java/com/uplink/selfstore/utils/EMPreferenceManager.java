...
public class EMPreferenceManager {
    ...
    private static EMPreferenceManager mPreferencemManager;
    ...
    private EMPreferenceManager(Context cxt) {
    ...
    public static synchronized void init(Context cxt){
        if(mPreferencemManager == null){
            mPreferencemManager = new EMPreferenceManager(cxt);
        }
    }
     ...
     * @return
     */
    public synchronized static EMPreferenceManager getInstance() {
        if (mPreferencemManager == null) {
