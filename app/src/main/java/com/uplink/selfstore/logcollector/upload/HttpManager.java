package com.uplink.selfstore.logcollector.upload;
...
public class HttpManager {
    ...
    public static String uploadFile(String url, HttpParameters params, File logFile) throws IOException {

        LogHelper.d("HttpManager","上传路径：" + url);
        ...
        try {
            ...
            LogHelper.d("HttpManager","result：" + result);
...
//    public static String uploadFile(String url1, HttpParameters params, File logFile) throws IOException {
//
//        String result = null;
//
//        String BOUNDARY = "---------------------------7db1c523809b2";//数据分割线
//        File file = logFile;   // 要上传的文件
//
...
//            out.close();
//
//            //LogHelper.d("carter", "multipart 返回码为: " + conn.getResponseCode());
//            //LogHelper.d("carter", "multipart 返回信息为: " + conn.getResponseMessage());
//
