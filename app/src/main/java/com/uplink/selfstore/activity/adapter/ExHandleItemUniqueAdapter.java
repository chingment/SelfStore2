...
public class ExHandleItemUniqueAdapter extends BaseAdapter {

    private static final String TAG = "ExHandleItemUniqueAdapter";

    private Context context;
    private List<ExHandleUniqueBean> exOrderDetailItems;
    private List<ExHandleItemBean> exOrders;
    public ExHandleItemUniqueAdapter(Context context, List<ExHandleItemBean> exOrders, List<ExHandleUniqueBean> exOrderDetailItems) {
    ...
    public View getView(int position, View convertView, ViewGroup parent) {
        ...
        final ExHandleUniqueBean exOrderDetailItem = exOrderDetailItems.get(position);
