...
import com.uplink.selfstore.utils.EasemobHelper;
import com.uplink.selfstore.utils.EasemobPhoneStateManager;
...
public class EasemobVideoCallActivity extends EasemobCallActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        if (!isInComingCall) {// outgoing call
            ...
            String st = getResources().getString(R.string.callvideo_are_connected_to_each_other);
                ...
                switch (callState) {
                    ...
                    case CONNECTING: // is connecting
                        runOnUiThread(new Runnable() {
                            ...
                            @Override
                            public void run() {
                                callStateTextView.setText(R.string.callvideo_are_connected_to_each_other);
                            }
                    ...
                    case ACCEPTED: // call is accepted
                        ...
                        runOnUiThread(new Runnable() {
                            ...
                            public void run() {
                                ...
                                callStateTextView.setText(R.string.callvideo_in_the_call);
//                            recordBtn.setVisibility(View.VISIBLE);
                                callingState = CallingState.NORMAL;
                                startMonitor();
                                // Start to watch the phone call state.
                                EasemobPhoneStateManager.get(EasemobVideoCallActivity.this).addStateCallback(phoneStateCallback);
                            }
                        ...
                        runOnUiThread(new Runnable() {
                            public void run() {
                                ...
                                if(error == CallError.ERROR_NO_DATA){
                                    netwrokStatusVeiw.setText(R.string.callvideo_no_call_data);
                                }else{
                        ...
                        runOnUiThread(new Runnable() {
                            private void postDelayedCloseMsg() {
                                uiHandler.postDelayed(new Runnable() {
                                    ...
                                    public void run() {
                                        ...
                                        EasemobPhoneStateManager.get(EasemobVideoCallActivity.this).removeStateCallback(phoneStateCallback);
                            ...
                            public void run() {
                                ...
                                if (fError == CallError.REJECTED) {
                                    ...
                                    callStateTextView.setText(R.string.callvideo_version_inconsistent);
...
//                                        callStateTextView.setText(s6);
                                ...
                                Toast.makeText(EasemobVideoCallActivity.this, callStateTextView.getText(), Toast.LENGTH_SHORT).show();
                                postDelayedCloseMsg();
                            }
    ...
    EasemobPhoneStateManager.PhoneStateCallback phoneStateCallback = new EasemobPhoneStateManager.PhoneStateCallback() {
        @Override
