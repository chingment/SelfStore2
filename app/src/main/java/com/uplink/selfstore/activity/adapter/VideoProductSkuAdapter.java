...
import com.uplink.selfstore.model.chat.ProductSkuBean;

import java.util.ArrayList;
import java.util.List;

public class VideoProductSkuAdapter extends BaseAdapter {

    private static final String TAG = "ProductSkuAdapter";
    private Context context;
    private List<ProductSkuBean> items = new ArrayList<>();

    public VideoProductSkuAdapter(Context context, List<ProductSkuBean> items) {
