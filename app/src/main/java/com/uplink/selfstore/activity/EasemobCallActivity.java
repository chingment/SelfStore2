...
import com.uplink.selfstore.utils.EasemobPreferenceManager;

import java.io.InputStream;

@SuppressLint("Registered")
public class EasemobCallActivity extends SwipeBackActivity {
            ...
            switch (msg.what) {
                ...
                case MSG_CALL_MAKE_VOICE:
                    try {
                        ...
                        //todo 拨打
                        boolean record = EasemobPreferenceManager.getInstance().isRecordOnServer();
                        boolean merge = EasemobPreferenceManager.getInstance().isMergeStream();
                        ...
                        runOnUiThread(new Runnable() {
                            public void run() {
                                ...
                                if (e.getErrorCode() == EMError.CALL_REMOTE_OFFLINE) {
                                    st2 = getResources().getString(R.string.callvideo_the_other_is_not_online);
                                } else if (e.getErrorCode() == EMError.USER_NOT_LOGIN) {
                                    st2 = getResources().getString(R.string.callvideo_is_not_yet_connected_to_the_server);
                                } else if (e.getErrorCode() == EMError.INVALID_USER_NAME) {
                                    st2 = getResources().getString(R.string.callvideo_illegal_user_name);
                                } else if (e.getErrorCode() == EMError.CALL_BUSY) {
                                    st2 = getResources().getString(R.string.callvideo_the_other_is_on_the_phone);
                                ...
                                Toast.makeText(EasemobCallActivity.this, st2, Toast.LENGTH_SHORT).show();
                                finish();
                            }
                        });
                    }
...
//                        }
    ...
    protected void saveCallRecord() {
        ...
        String st1 = getResources().getString(R.string.callvideo_call_duration);
        String st2 = getResources().getString(R.string.callvideo_refused);
        String st3 = getResources().getString(R.string.callvideo_the_other_party_has_refused_to);
        String st4 = getResources().getString(R.string.callvideo_the_other_is_not_online);
        String st5 = getResources().getString(R.string.callvideo_the_other_is_on_the_phone);
        String st6 = getResources().getString(R.string.callvideo_the_other_party_did_not_answer);
        String st7 = getResources().getString(R.string.callvideo_did_not_answer);
        String st8 = getResources().getString(R.string.callvideo_has_been_cancelled);
        ...
        switch (callingState) {
            ...
            case VERSION_NOT_SAME:
                txtBody = new EMTextMessageBody(getString(R.string.callvideo_version_inconsistent));
                break;
