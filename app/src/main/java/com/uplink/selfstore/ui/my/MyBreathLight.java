 ...
 * description：
 */
public class MyBreathLight extends View implements ValueAnimator.AnimatorUpdateListener {
    /**
     * 扩散圆圈颜色
     */
    ...
    public MyBreathLight(Context context) {
        this(context, null);
    }

    public MyBreathLight(Context context, AttributeSet attrs) {
        this(context, attrs, 0);
    }

    public MyBreathLight(Context context, AttributeSet attrs, int defStyleAttr) {
     ...
     * @param radius
     */
    public MyBreathLight setCoreRadius(float radius) {
        mCoreRadius = radius;
        return this;
    }
     ...
     * @param width
     */
    public MyBreathLight setDiffusMaxWidth(float width) {
        mMaxWidth = width;
        return this;
    }
     ...
     * @param y
     */
    public MyBreathLight setCoordinate(float x, float y) {
        circleX = x;
        circleY = y;
        return this;
    }
     ...
     * @param color
     */
    public MyBreathLight setDiffusColor(int color) {
     ...
     * @param coreColor
     */
    public MyBreathLight setCoreColor(int coreColor) {
     ...
     * @param durataion
     */
    public MyBreathLight setInterval(long durataion) {
