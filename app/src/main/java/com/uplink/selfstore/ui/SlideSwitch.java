...
public class SlideSwitch extends View {
    ...
    private static final int COLOR_THEME_FALSE = Color.GRAY;
    // 3 attributes
    private int color_theme;
    private int color_theme_false;
    ...
    private SlideCheckListener checkListener;
    ...
    public SlideSwitch(Context context, AttributeSet attrs, int defStyleAttr) {
        ...
        color_theme = a.getColor(R.styleable.slideswitch_themeColor,
                COLOR_THEME);
        color_theme_false = a.getColor(R.styleable.slideswitch_themeColorFalse,
                COLOR_THEME_FALSE);
...
//            paint.setAlpha(alpha);
    ...
    boolean enabless = true;

    public void setEnabless(boolean enabless) {
    ...
    public void setSlideCheckListener(SlideCheckListener listener) {
            ...
            public void handleMessage(Message msg) {
                if (msg.what == 1) {
                    ...
                    if (checkListener != null)
                        checkListener.check(SlideSwitch.this, true);
                } else {
                    if (listener != null)
                        listener.close();
                    if (checkListener != null)
                        checkListener.check(SlideSwitch.this, false);
                }
            }
    ...
    public void setState(boolean isOpen) {
        ...
        if (checkListener != null)
            checkListener.check(this, isOpen);
    }
