...
public class MyHorizontalListView extends AdapterView<ListAdapter>
{
	...
	private OnGestureListener mOnGesture = new GestureDetector.SimpleOnGestureListener()
	{
		...
		public boolean onFling(MotionEvent e1, MotionEvent e2, float velocityX,
				float velocityY)
		{
			return MyHorizontalListView.this
		...
		public boolean onSingleTapConfirmed(MotionEvent e)
		{
			for (int i = 0; i < getChildCount(); i++)
			{
				...
				if (isEventWithinView(e, child))
				{
					...
					{
						mOnItemClicked.onItemClick(MyHorizontalListView.this,
								child, mLeftViewIndex + 1 + i,
								mAdapter.getItemId(mLeftViewIndex + 1 + i));
					}
					if (mOnItemSelected != null)
					{
						mOnItemSelected.onItemSelected(MyHorizontalListView.this,
								child, mLeftViewIndex + 1 + i,
								mAdapter.getItemId(mLeftViewIndex + 1 + i));
					}
					break;
				...
				if (isEventWithinView(e, child))
				{
					if (mOnItemLongClicked != null)
					{
						mOnItemLongClicked.onItemLongClick(
								MyHorizontalListView.this, child, mLeftViewIndex
										+ 1 + i,
								mAdapter.getItemId(mLeftViewIndex + 1 + i));
					}
					break;
