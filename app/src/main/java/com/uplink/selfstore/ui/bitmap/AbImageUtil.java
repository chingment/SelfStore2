...
import com.uplink.selfstore.utils.AbMathUtil;
import com.uplink.selfstore.utils.dct.FDCT;
...
//				Log.d(TAG, "" + e.getMessage());
	...
	public static TransitionDrawable bitmapToTransitionDrawable(Context context, Bitmap bitmap) {
		...
		try {
			...
			mBitmapDrawable = new TransitionDrawable(new Drawable[] { new ColorDrawable(context.getResources().getColor(android.R.color.transparent)),
