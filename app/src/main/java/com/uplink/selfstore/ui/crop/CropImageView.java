...
package com.uplink.selfstore.ui.crop;
...
import com.uplink.selfstore.ui.crop.cropwindow.CropOverlayView;
import com.uplink.selfstore.ui.crop.cropwindow.edge.Edge;
import com.uplink.selfstore.ui.crop.util.ImageViewUtil;
...
public class CropImageView extends FrameLayout {
	...
	public Bitmap getCroppedImage() {
		...
		final Bitmap croppedBitmap = Bitmap
				.createBitmap(mBitmap, (int) actualCropX, (int) actualCropY, (int) actualCropWidth, (int) actualCropHeight);
